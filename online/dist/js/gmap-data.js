...
$(function () {
	...
	if( $('#map_canvas').length > 0 ){	
		var settings = {
			zoom: 10,
			center: new google.maps.LatLng(9.9178076,78.061781),
	...
	var settings = {
		zoom: 10,
		center: new google.maps.LatLng(9.9096369,78.1432104),
		mapTypeControl: false,
		scrollwheel: false,
		draggable: true,
		panControl:false,
	...
	var companyPos = new google.maps.LatLng(9.9096369,78.1432104);	
	var companyMarker = new google.maps.Marker({
		position: companyPos,
		map: map,
		title:"Our Office",
